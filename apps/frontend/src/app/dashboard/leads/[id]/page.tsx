...
export default function LeadDetailPage({ params }: PageProps) {
  ...
  const NEXT_STATUS: Record<string, string> = {
    ...
    FORMULARIO_PREENCHIDO: "EM_ANALISE",
    EM_ANALISE: "ANALISADO",
    ANALISADO: "REUNIAO_AGENDADA",
    REUNIAO_AGENDADA: "REUNIAO_REALIZADA",
    REUNIAO_REALIZADA: "ESCOPO_GERADO",
    ESCOPO_GERADO: "ESCOPO_APROVADO",
    ESCOPO_APROVADO: "PROPOSTA_ENVIADA",
    PROPOSTA_ENVIADA: "PROPOSTA_ACEITA",
    PROPOSTA_ACEITA: "CONTRATO_ENVIADO",
    CONTRATO_ENVIADO: "CONTRATO_ASSINADO",
    CONTRATO_ASSINADO: "AGUARDANDO_PAGAMENTO",
    AGUARDANDO_PAGAMENTO: "PAGO_PARCIAL",
    PAGO_PARCIAL: "PAGO_TOTAL",
    PAGO_TOTAL: "PROJETO_INICIADO",
  };
